...
public class ExplosiveTool4x4 extends SimpleSlimefunItem<ToolUseHandler> implements NotPlaceable, DamageableItem {
    ...
    public ExplosiveTool4x4(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    private void breakBlocks(BlockBreakEvent e, Player p, ItemStack item, Block b, List<Block> blocks, List<ItemStack> drops) {
        ...
        ExplosiveToolBreakBlocksEvent4x4 event = new ExplosiveToolBreakBlocksEvent4x4(p, b, blocksToDestroy, item, this);
    ...
    private List<Block> findBlocks(Block b) {
        List<Block> blocks = new ArrayList<>(80);
