...
/**
 * This {@link Event} is called when an {@link me.pranavverma.advancedtech.general.items.diggers.lib.basic.ExplosiveTool4x4} is used to break blocks.
 *
 * @author GallowsDove
 *
 * @see me.pranavverma.advancedtech.general.items.diggers.lib.basic.ExplosiveTool4x4
 *
 */
public class ExplosiveToolBreakBlocksEvent4x4 extends PlayerEvent implements Cancellable {
    ...
    private final me.pranavverma.advancedtech.general.items.diggers.lib.basic.ExplosiveTool4x4 explosiveTool4x4;
    private final Block mainBlock;
    private final List<Block> additionalBlocks;
    private boolean cancelled;

    @ParametersAreNonnullByDefault
    public ExplosiveToolBreakBlocksEvent4x4(Player player, Block block, List<Block> blocks, ItemStack item, me.pranavverma.advancedtech.general.items.diggers.lib.basic.ExplosiveTool4x4 explosiveTool4x4) {
        super(player);
    ...
    @Nonnull
    public me.pranavverma.advancedtech.general.items.diggers.lib.basic.ExplosiveTool4x4 getExplosiveTool() {
